...
public class Cadastro {
    ...
    void deletarProduto(){
        ...
        produtos.deleteProdutos(scanner.nextLine());
        bancoDeDados.close();
    }
    ...
    void adicionarFuncionario(){
        ...
        funcionario.inserirFuncionario(lista);
        bancoDeDados.close();
    }
    ...
    void lerFuncionario(){
        ...
        funcionario.lerFuncionario(scanner.nextLine());
        bancoDeDados.close();
    }
    void deletarFuncionario(){
        bancoDeDados.connect();
        System.out.println("Digite o nome do funcionario a ser deletado: ");
        funcionario.deleteFuncionario(scanner.nextLine());
        bancoDeDados.close();
    }
    void imprimirMenu(){
